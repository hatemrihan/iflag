...
const Pricing: FC = () => {
  return ( <section className="section" id="pricing">
    <div className="border-white py-12 px-4 md:px-16 lg:px-32">
      <h2 className="text-4xl mb-4 md:text-7xl lg:text-8xl text-center text-black">OUR PRICES</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-black  p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="mt-2 text-white text-sm">Unlimited Sessions Memberships</p>
          ...
          <a href="#ContactForm"><button className="mt-6  bg-stone-900 px-6 py-2 rounded-lg text-white hover:bg-orange-500">Purchase</button> </a>
        </div>
        ...
        <div className="bg-black p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="mt-2 text-white text-sm">Avg 10 Sessions/Month</p>
          <ul className="mt-4 text-lg text-gray-400">
        ...
        <div className="bg-black p-6 rounded-lg shadow-lg text-center">
          ...
          <p className="mt-2 text-white text-sm">12 Sessions/Month</p>
          <ul className="mt-4 text-lg text-gray-400">
