...
const Button=(props:{
    ...
    return (
        <button className={twMerge("h-11 px-6 rounded-xl  border border-red-orange-500 hover:text-white uppercase inline-flex items-center gap-2 transition duration-500 relative group/button",variant ==="primary" && "bg-red-orange-500",
